---
title: "Building Kismet for the Wi-Fi Pinapple Tetra"
...
## Warning: Older OpenWRT

Older OpenWRT platforms (like the stock Tetra codebase of 15.05) have problems with C++11 and newer conventions used in Kismet.  You may find that you need to run a remote capture source on the Tetra and run Kismet on a more modern, and powerful, system.
